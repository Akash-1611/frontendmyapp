  ...
  return (
    ...
    <div>
       ...
       <p className='-my-2 text-sm'>
        {
           dataUser.online ? <span className='text-green-800'> online </span>: <span className='text-slate-400'>offline</span>
           }
       </p>
       </div>
       </div>
      <div>
      <button className='cursor-pointer hover:text-slate-400'>
      <HiDotsVertical />
      ...
      <section className='h-[calc(100vh-128px)] overflow-x-hidden overflow-y-scroll scrollbar relative bg-slate200 bg-opacity-40'>
       {/* image */}
...

{
      ...
      <section className='h-16 bg-white flex items-center px-4'>
        ...
        <button onClick={handleUploadImageVideoOpen}className='flex justify-center items-center w-11 h-11 rounded-full hover:bg-blue-500  hover:text-white'>
         <FiPlus 
         size={20}/> 
        </button>
